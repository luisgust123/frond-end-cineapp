...
@NgModule({
  declarations: [
    ...
    RolEdicionComponent,
    RolUsuarioComponent,
    RolUsuarioEdicionComponent,
    RolMenuComponent,
    RolMenuEdicionComponent
  ],
  entryComponents: [GeneroDialogoComponent, ComidaDialogoComponent, ConsultaDialogoComponent, ConfiguracionDialogoComponent],
  imports: [
    BrowserModule,
    AppRoutingModule,
    MaterialModule,
